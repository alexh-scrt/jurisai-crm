...
export function BorderedAnimated() {
    ...
    <div className="h-screen flex flex-col bg-muted/25">
      ...
      <header className="h-11 flex items-center justify-between px-4 bg-background/95 backdrop-blur-sm border-b-2 border-primary/20">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">Animated Connections</span>
          </div>
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className={cn(
          ...
          <div className={cn(borderedPanel, "border-l-4 border-l-primary", "rounded-xl overflow-hidden")}>
        ...
        <div className="absolute inset-0 flex items-center justify-center" style={{ transform: `scale(${zoom / 100})` }}>
          <div className="relative w-[800px] h-[500px]">
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none">
              <defs>
                <marker id="arrowhead-animated" markerWidth="12" markerHeight="8" refX="10" refY="4" orient="auto">
              ...
              {/* Connection 1: Case Intake -> Extract Facts */}
              <path
              ...
              <path
                ...
                strokeWidth="2"
                fill="none"
                className="text-primary animated-path"
                markerEnd="url(#arrowhead-animated)"
              />

              {/* Connection 2: Extract Facts -> Legal Analysis */}
              <path
              ...
              {/* Connection 3: Legal Analysis -> Generate Report */}
              <path
              ...
              {/* Flow indicator dots */}
              <circle r="4" className="fill-green-500 pulse-arrow">
                <animateMotion dur="2s" repeatCount="indefinite" path="M 175 140 C 220 140, 220 175, 265 175" />
              </circle>
              <circle r="4" className="fill-blue-500 pulse-arrow">
                <animateMotion dur="2s" repeatCount="indefinite" path="M 365 175 L 455 175" />
              </circle>
              <circle r="4" className="fill-purple-500 pulse-arrow">
                <animateMotion dur="2s" repeatCount="indefinite" path="M 555 175 L 645 175" />
              </circle>
            </svg>

            {/* Nodes */}
            <div className={cn(
              "absolute left-8 top-24 w-36 rounded-xl p-4 cursor-pointer transition-all hover:shadow-xl hover:scale-105",
              borderedPanel,
            ...
            <div className={cn(
              "absolute left-56 top-36 w-36 rounded-xl p-4 cursor-pointer transition-all hover:shadow-xl hover:scale-105",
              borderedPanel,
            ...
            <div className={cn(
              "absolute left-[400px] top-36 w-36 rounded-xl p-4 cursor-pointer transition-all hover:shadow-xl hover:scale-105",
              borderedPanel,
              "border-l-4 border-l-blue-500"
            )}>
              <div className="flex items-center gap-2 mb-2">
            ...
            <div className={cn(
              "absolute right-8 top-36 w-36 rounded-xl p-4 cursor-pointer transition-all hover:shadow-xl hover:scale-105",
              borderedPanel,
