...
export function BorderedClassic() {
      ...
      <header className="h-11 flex items-center justify-between px-4 bg-background/95 backdrop-blur-sm border-b-2 border-primary/20">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">Classic Bordered</span>
          </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center" style={{ transform: `scale(${zoom / 100})` }}>
          <div className="relative w-[800px] h-[500px]">
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ overflow: 'visible' }}>
              <defs>
                <marker id="arrowhead-classic" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
                  <polygon points="0 0, 10 3.5, 0 7" className="fill-primary/60" />
                </marker>
              </defs>
              {/* Case Intake -> Extract Facts */}
              <path
              ...
              <path
                ...
                markerEnd="url(#arrowhead-classic)"
              />
              {/* Legal Analysis -> Generate Report */}
              <path
